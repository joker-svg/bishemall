            ...
            right_scroll:function () {
                ...
                var f = this.goodslist_length*244.5 + this.box;
                 if(f > 0)
                 {
                     if(f < 2450)
                     {
                         this.box = this.box-f+1222.5;
                         this.box_left = this.box + 'px';
                     }
                     else{
                         this.box = this.box - 1222.5;
                         this.box_left = this.box + 'px';
                     }
                 }
            ...
            left_scroll:function () {
                if(this.box < 0)
                {
                    if(this.box >= -1225)
                    {
                        ...
                        this.box = this.box + 1225;
                        this.box_left = this.box + 'px';
                    }
                }
            },
            jiekou:function () {
                this.$store.dispatch('getDiscount',{product_id:5}).then(res => {});
            },
